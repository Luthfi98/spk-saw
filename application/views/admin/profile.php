    ...
    <div class="card card-shadow text-center">
      <div class="card-block">
        <a class="avatar avatar-lg" href="javascript:void(0)">
          <img src="<?= base_url('assets/img/').$profile->gambar ?>" alt="...">
        </a>
        <h4 class="profile-user"><?= ucfirst($profile->username) ?></h4>
        <p class="profile-job"><?= ucfirst($profile->nama_jabatan) ?></p>
        <p><?= ucfirst($profile->deskripsi_jabatan) ?></p>
